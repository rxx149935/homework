...
def load_data(logger, frac=1):
    data, test_data = pd.read_csv("kaggle/input/plant-pathology-2020-fgvc7/train.csv"), pd.read_csv("kaggle/input/plant-pathology-2020-fgvc7/sample_submission.csv")
    # Do fast experiment
    if frac < 1:
